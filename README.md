...
### $.param
将表单元素数组或者对象序列化。如果shallow设置为true，嵌套对象不会被序列化，嵌套数组的值不会使用放括号在他们的key上。<br>
$.param(object, [shallow])   ⇒ string <br>
$.param(array)   ⇒ string
...
### $.isPlainObject
$.isPlainObject(object)   ⇒ boolean<br>
...
width()   ⇒ number</br>
width(value)   ⇒ self</br>
width(function(index, oldWidth){ ... })   ⇒ self</br>
...
### height
height()   ⇒ number</br>
height(value)   ⇒ self</br>
height(function(index, oldWidth){ ... })   ⇒ self</br>
...
### not
not(selector)   ⇒ collection<br>
not(collection)   ⇒ collection<br>
not(function(index){ ... })   ⇒ collection<br>
